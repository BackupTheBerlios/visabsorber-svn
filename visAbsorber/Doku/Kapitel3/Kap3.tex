...
\begin{figure}[!htbp]
			\begin{center}
				\includegraphics[scale = .9]{../Kapitel3/Bilder/colorbar.eps}
				\caption{Colorbar}
				\label{kap3:colorbar}
  		\end{center}  
\end{figure}
...
Beispiele für Formeln gibt es in \ref{sec:formeln}

\subsection{Tabellen}

\subparagraph{und in Matlab...}

Beispiel für tabular-Umgebung
...
Das ganze nun mit longtable und hhline
